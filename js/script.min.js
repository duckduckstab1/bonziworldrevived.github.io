                            ...
                            if (useSapi5) {
                                ...
                                if (this.userPublic.voice == "jennifer") {
                                    ...
                                    if (this.color == "peedy") {
                                        ...
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=Adult%20Female%20%232%2C%20American%20English%20(TruVoice)&pitch=200&speed=150")
                                        await this.aud.play();
                                    } else if (this.color == "robby") {
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=Adult%20Female%20%237%2C%20American%20English%20(TruVoice)&pitch=50&speed=150")
                                        await this.aud.play();
                                    } else {
