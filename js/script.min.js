                        ...
                        var e = "&gt;" == a.substring(0, 4) || ">" == a[0];
                            ...
                            if (useSapi5) {
                                ...
                                if (this.userPublic.voice == "jennifer") {
                                    ...
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    if (this.color == "peedy") {
                                        this.aud = await new Audio("http://server.bonziworldrevived.tk:8080/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%232%2C%20American%20English%20(TruVoice)&pitch=100&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("http://server.bonziworldrevived.tk:8080/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%231%2C%20American%20English%20(TruVoice)&pitch=50&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("http://server.bonziworldrevived.tk:8080/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%231%2C%20American%20English%20(TruVoice)&pitch=100&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("http://server.bonziworldrevived.tk:8080/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%233%2C%20American%20English%20(TruVoice)&pitch=50&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("http://server.bonziworldrevived.tk:8080/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%231%2C%20American%20English%20(TruVoice)&pitch=80&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("http://server.bonziworldrevived.tk:8080/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%233%2C%20American%20English%20(TruVoice)&pitch=200&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("http://server.bonziworldrevived.tk:8080/SAPI4/SAPI4?text="+b+"&voice=Adult%20Female%20%231%2C%20American%20English%20(TruVoice)&pitch=200&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("http://server.bonziworldrevived.tk:8080/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%231%2C%20American%20English%20(TruVoice)&pitch=200&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("http://server.bonziworldrevived.tk:8080/SAPI4/SAPI4?text="+b+"&voice=English-American%3A%20Default%20(English)&pitch=118&speed=17")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("http://server.bonziworldrevived.tk:8080/SAPI4/SAPI4?text="+b+"&voice=RoboSoft%20Three&pitch=113&speed=170")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("http://server.bonziworldrevived.tk:8080/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%237%2C%20American%20English%20(TruVoice)&pitch=50&speed=150")
                                        if (window.gain > 1) {
                                        ...
                                        this.aud = await new Audio("http://server.bonziworldrevived.tk:8080/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%232%2C%20American%20English%20(TruVoice)&pitch=140&speed=157")
                                        if (window.gain > 1) {
