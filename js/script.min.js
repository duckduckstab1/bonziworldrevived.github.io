                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        if (this.source && this.analyser) {
                            ...
                            if (this.color != "purple" && this.color != "red" && this.color != "green" && this.color != "blue" && this.color != "black" && this.color != "brown") return;
                            ...
                            if (useSapi5) {
                                ...
                                if (this.userPublic.voice == "jennifer") {
                                    ...
                                    if (this.color == "peedy") {
                                        ...
                                        this.aud = await new Audio("https://server.bonziworldrevived.tk:8443/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%233%2C%20American%20English%20(TruVoice)&pitch=150&speed=145")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
