                        ...
                        var e = "&gt;" == a.substring(0, 4) || ">" == a[0];
                            ...
                            if (useSapi5) {
                                ...
                                if (this.userPublic.voice == "jennifer") {
                                    ...
                                    this.$dialogCont.html("<progress></progress><br>"+this.userPublic.name+"'s voice is loading..")
                                    if (this.color == "peedy") {
                                        this.aud = await new Audio("//bonziworldrevived.tk/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%232%2C%20American%20English%20(TruVoice)&pitch=100&speed=150")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
                                        ...
                                        this.aud = await new Audio("//bonziworldrevived.tk/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%231%2C%20American%20English%20(TruVoice)&pitch=50&speed=150")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
                                        ...
                                        this.aud = await new Audio("//bonziworldrevived.tk/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%231%2C%20American%20English%20(TruVoice)&pitch=100&speed=150")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
                                        ...
                                        this.aud = await new Audio("//bonziworldrevived.tk/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%233%2C%20American%20English%20(TruVoice)&pitch=50&speed=150")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
                                        ...
                                        this.aud = await new Audio("//bonziworldrevived.tk/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%233%2C%20American%20English%20(TruVoice)&pitch=150&speed=145")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
                                        ...
                                        this.aud = await new Audio("//bonziworldrevived.tk/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%231%2C%20American%20English%20(TruVoice)&pitch=80&speed=150")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
                                        ...
                                        this.aud = await new Audio("//bonziworldrevived.tk/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%233%2C%20American%20English%20(TruVoice)&pitch=200&speed=150")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
                                        ...
                                        this.aud = await new Audio("//bonziworldrevived.tk/SAPI4/SAPI4?text="+b+"&voice=Adult%20Female%20%231%2C%20American%20English%20(TruVoice)&pitch=200&speed=150")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
                                        ...
                                        this.aud = await new Audio("//bonziworldrevived.tk/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%231%2C%20American%20English%20(TruVoice)&pitch=200&speed=150")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
                                        ...
                                        this.aud = await new Audio("//bonziworldrevived.tk/SAPI4/SAPI4?text="+b+"&voice=English-American%3A%20Default%20(English)&pitch=118&speed=17")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
                                        ...
                                        this.aud = await new Audio("//bonziworldrevived.tk/SAPI4/SAPI4?text="+b+"&voice=RoboSoft%20Three&pitch=113&speed=170")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
                                        ...
                                        this.aud = await new Audio("//bonziworldrevived.tk/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%237%2C%20American%20English%20(TruVoice)&pitch=50&speed=150")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
                                        ...
                                        this.aud = await new Audio("//bonziworldrevived.tk/SAPI4/SAPI4?text="+b+"&voice=Adult%20Male%20%232%2C%20American%20English%20(TruVoice)&pitch=140&speed=157")
                                        await this.aud.play();
                                        this.source = this.auCtx.createMediaElementSource(this.aud);
                                        this.gainNode = this.auCtx.createGain();
                                        this.source.connect(this.gainNode).connect(this.auCtx.destination);
...
var undefined,
    ...
    socket = io("//bonziworldrevived.tk:"+window.location.port,{query:{ channel: "bonziuniverse-revived" }}),
	call,
    usersPublic = {},
    bonzis = {},
    debug = !0;	
